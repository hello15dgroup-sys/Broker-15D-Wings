...
export const GOOGLE_FONTS: GoogleFontSpec[] = [
  ...
  { name: 'Lexend', family: 'Lexend, sans-serif', category: 'Modern' },
  { name: 'DM Sans', family: 'DM Sans, sans-serif', category: 'Modern' },
  ...
  { name: 'Work Sans', family: 'Work Sans, sans-serif', category: 'Modern' },
  { name: 'Bodoni Moda', family: 'Bodoni Moda, serif', category: 'Luxury' },
  { name: 'Space Mono', family: 'Space Mono, monospace', category: 'Mono' },
  { name: 'UnifrakturMaguntia', family: 'UnifrakturMaguntia, cursive', category: 'Display' },
