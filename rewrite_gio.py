...
start_idx = content.find("function GIODashboard() {")
end_idx = content.find("  );\n}\n", start_idx) + 7

dashboard_code = '''function GIODashboard() {
...
open('src/pages/GIOInterface.tsx', 'w').write(content[:start_idx] + dashboard_code)
